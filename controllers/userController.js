...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'ss0986825@gmail.com', // this is the email that will be used to send the email.
        pass: 'ough ieqe xtkp hksu', //this is the password that is created in app passwords in gmail setting options.
    },
});
